...
test_silife:
	iverilog -I src -s silife -s dump -o silife_test.out test/dump_silife.v src/silife.v src/buf_reg.v src/cell.v src/grid_32x32.v src/grid_loader.v src/grid_sync.v src/grid_sync_edge.v src/grid_wishbone.v src/max7219.v src/spi_master.v src/trng.v src/grid_trng_loader.v src/vga.v src/vga_sync_gen.v
